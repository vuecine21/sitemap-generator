...
(function RegisterEventListeners(sitemapGenerator, centeredWindow) {
     ...
     * @param sender - details on which window/tab send the message, provided by chrome, @see {@link https://developer.chrome.com/extensions/runtime#type-MessageSender|MessageSender}
     ...
     * @param {Object} details - provided by chrome @see {@link https://developer.chrome.com/apps/runtime#event-onInstalled|OnIstalled}
     */
     ...
     * @param {Object} tab - current active tab, @see {@link https://developer.chrome.com/extensions/browserAction#event-onClicked|onClicked}
     */
     ...
     * @param {Object} sender - details on which window/tab send the message, @see {@link https://developer.chrome.com/extensions/runtime#type-MessageSender|MessageSender}
     */
